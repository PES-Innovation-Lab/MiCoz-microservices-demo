...
type SetSpeedRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DelaySize     int32                  `protobuf:"varint,1,opt,name=delay_size,json=delaySize,proto3" json:"delay_size,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetSpeedRequest) GetDelaySize() int32 {
	if x != nil {
		return x.DelaySize
	}
	return 0
...
func (x *GetDelayRequest) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
type GetDelayResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GlobalDelay   int32                  `protobuf:"varint,1,opt,name=global_delay,json=globalDelay,proto3" json:"global_delay,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetDelayResponse) GetGlobalDelay() int32 {
	if x != nil {
		return x.GlobalDelay
	}
	return 0
}

type IncDelayRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Endpoint      string                 `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	DelaySize     int32                  `protobuf:"varint,2,opt,name=delay_size,json=delaySize,proto3" json:"delay_size,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IncDelayRequest) Reset() {
	*x = IncDelayRequest{}
...
func (x *IncDelayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IncDelayRequest) ProtoMessage() {}

func (x *IncDelayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IncDelayRequest.ProtoReflect.Descriptor instead.
func (*IncDelayRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{35}
}

func (x *IncDelayRequest) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *IncDelayRequest) GetDelaySize() int32 {
	if x != nil {
		return x.DelaySize
	}
	return 0
...
const file_demo_proto_rawDesc = "" +
	...
	"\x0fSetSpeedRequest\x12\x1d\n" +
	"\n" +
	"delay_size\x18\x01 \x01(\x05R\tdelaySize\"-\n" +
	"\x0fGetDelayRequest\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\"5\n" +
	"\x10GetDelayResponse\x12!\n" +
	"\fglobal_delay\x18\x01 \x01(\x05R\vglobalDelay\"L\n" +
	"\x0fIncDelayRequest\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x12\x1d\n" +
	"\n" +
	"delay_size\x18\x02 \x01(\x05R\tdelaySize2\xc2\x02\n" +
	"\vCartService\x12<\n" +
	...
	"\tEmptyCart\x12\x1d.hipstershop.EmptyCartRequest\x1a\x12.hipstershop.Empty\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\x83\x01\n" +
	"\x15RecommendationService\x12j\n" +
	"\x13ListRecommendations\x12'.hipstershop.ListRecommendationsRequest\x1a(.hipstershop.ListRecommendationsResponse\"\x002\xfb\x02\n" +
	...
	"\x0eSearchProducts\x12\".hipstershop.SearchProductsRequest\x1a#.hipstershop.SearchProductsResponse\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xa2\x02\n" +
	"\x0fShippingService\x12I\n" +
	"\bGetQuote\x12\x1c.hipstershop.GetQuoteRequest\x1a\x1d.hipstershop.GetQuoteResponse\"\x00\x12L\n" +
	"\tShipOrder\x12\x1d.hipstershop.ShipOrderRequest\x1a\x1e.hipstershop.ShipOrderResponse\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xaf\x02\n" +
	...
	"\aConvert\x12&.hipstershop.CurrencyConversionRequest\x1a\x12.hipstershop.Money\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xcd\x01\n" +
	"\x0ePaymentService\x12C\n" +
	"\x06Charge\x12\x1a.hipstershop.ChargeRequest\x1a\x1b.hipstershop.ChargeResponse\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xe0\x01\n" +
	"\fEmailService\x12X\n" +
	"\x15SendOrderConfirmation\x12).hipstershop.SendOrderConfirmationRequest\x1a\x12.hipstershop.Empty\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xda\x01\n" +
	"\x0fCheckoutService\x12O\n" +
	"\n" +
	"PlaceOrder\x12\x1e.hipstershop.PlaceOrderRequest\x1a\x1f.hipstershop.PlaceOrderResponse\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xc0\x01\n" +
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x00\x12>\n" +
	"\bSetSpeed\x12\x1c.hipstershop.SetSpeedRequest\x1a\x12.hipstershop.Empty\"\x00\x126\n" +
	"\n" +
	"ClearState\x12\x12.hipstershop.Empty\x1a\x12.hipstershop.Empty\"\x002\xa3\x01\n" +
	"\n" +
	"DelayStore\x12O\n" +
	"\x0eGetGlobalDelay\x12\x1c.hipstershop.GetDelayRequest\x1a\x1d.hipstershop.GetDelayResponse\"\x00\x12D\n" +
	"\x0eIncGlobalDelay\x12\x1c.hipstershop.IncDelayRequest\x1a\x12.hipstershop.Empty\"\x00B?Z=github.com/GoogleCloudPlatform/microservices-demo/hipstershopb\x06proto3"
...
var file_demo_proto_goTypes = []any{
	...
	(*SetSpeedRequest)(nil),                // 32: hipstershop.SetSpeedRequest
	(*GetDelayRequest)(nil),                // 33: hipstershop.GetDelayRequest
	(*GetDelayResponse)(nil),               // 34: hipstershop.GetDelayResponse
	(*IncDelayRequest)(nil),                // 35: hipstershop.IncDelayRequest
}
var file_demo_proto_depIdxs = []int32{
	...
	32, // 26: hipstershop.CartService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 27: hipstershop.CartService.ClearState:input_type -> hipstershop.Empty
	...
	32, // 32: hipstershop.ProductCatalogService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 33: hipstershop.ProductCatalogService.ClearState:input_type -> hipstershop.Empty
	...
	32, // 36: hipstershop.ShippingService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 37: hipstershop.ShippingService.ClearState:input_type -> hipstershop.Empty
	5,  // 38: hipstershop.CurrencyService.GetSupportedCurrencies:input_type -> hipstershop.Empty
	20, // 39: hipstershop.CurrencyService.Convert:input_type -> hipstershop.CurrencyConversionRequest
	32, // 40: hipstershop.CurrencyService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 41: hipstershop.CurrencyService.ClearState:input_type -> hipstershop.Empty
	22, // 42: hipstershop.PaymentService.Charge:input_type -> hipstershop.ChargeRequest
	32, // 43: hipstershop.PaymentService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 44: hipstershop.PaymentService.ClearState:input_type -> hipstershop.Empty
	26, // 45: hipstershop.EmailService.SendOrderConfirmation:input_type -> hipstershop.SendOrderConfirmationRequest
	32, // 46: hipstershop.EmailService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 47: hipstershop.EmailService.ClearState:input_type -> hipstershop.Empty
	27, // 48: hipstershop.CheckoutService.PlaceOrder:input_type -> hipstershop.PlaceOrderRequest
	32, // 49: hipstershop.CheckoutService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 50: hipstershop.CheckoutService.ClearState:input_type -> hipstershop.Empty
	29, // 51: hipstershop.AdService.GetAds:input_type -> hipstershop.AdRequest
	32, // 52: hipstershop.AdService.SetSpeed:input_type -> hipstershop.SetSpeedRequest
	5,  // 53: hipstershop.AdService.ClearState:input_type -> hipstershop.Empty
	33, // 54: hipstershop.DelayStore.GetGlobalDelay:input_type -> hipstershop.GetDelayRequest
	35, // 55: hipstershop.DelayStore.IncGlobalDelay:input_type -> hipstershop.IncDelayRequest
	5,  // 56: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	4,  // 57: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	5,  // 58: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
	5,  // 59: hipstershop.CartService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 60: hipstershop.CartService.ClearState:output_type -> hipstershop.Empty
	7,  // 61: hipstershop.RecommendationService.ListRecommendations:output_type -> hipstershop.ListRecommendationsResponse
	9,  // 62: hipstershop.ProductCatalogService.ListProducts:output_type -> hipstershop.ListProductsResponse
	8,  // 63: hipstershop.ProductCatalogService.GetProduct:output_type -> hipstershop.Product
	12, // 64: hipstershop.ProductCatalogService.SearchProducts:output_type -> hipstershop.SearchProductsResponse
	5,  // 65: hipstershop.ProductCatalogService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 66: hipstershop.ProductCatalogService.ClearState:output_type -> hipstershop.Empty
	14, // 67: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	16, // 68: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
	5,  // 69: hipstershop.ShippingService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 70: hipstershop.ShippingService.ClearState:output_type -> hipstershop.Empty
	19, // 71: hipstershop.CurrencyService.GetSupportedCurrencies:output_type -> hipstershop.GetSupportedCurrenciesResponse
	18, // 72: hipstershop.CurrencyService.Convert:output_type -> hipstershop.Money
	5,  // 73: hipstershop.CurrencyService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 74: hipstershop.CurrencyService.ClearState:output_type -> hipstershop.Empty
	23, // 75: hipstershop.PaymentService.Charge:output_type -> hipstershop.ChargeResponse
	5,  // 76: hipstershop.PaymentService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 77: hipstershop.PaymentService.ClearState:output_type -> hipstershop.Empty
	5,  // 78: hipstershop.EmailService.SendOrderConfirmation:output_type -> hipstershop.Empty
	5,  // 79: hipstershop.EmailService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 80: hipstershop.EmailService.ClearState:output_type -> hipstershop.Empty
	28, // 81: hipstershop.CheckoutService.PlaceOrder:output_type -> hipstershop.PlaceOrderResponse
	5,  // 82: hipstershop.CheckoutService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 83: hipstershop.CheckoutService.ClearState:output_type -> hipstershop.Empty
	30, // 84: hipstershop.AdService.GetAds:output_type -> hipstershop.AdResponse
	5,  // 85: hipstershop.AdService.SetSpeed:output_type -> hipstershop.Empty
	5,  // 86: hipstershop.AdService.ClearState:output_type -> hipstershop.Empty
	34, // 87: hipstershop.DelayStore.GetGlobalDelay:output_type -> hipstershop.GetDelayResponse
	5,  // 88: hipstershop.DelayStore.IncGlobalDelay:output_type -> hipstershop.Empty
